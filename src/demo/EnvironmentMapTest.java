...
public class EnvironmentMapTest implements SceneGenerator {
	...
	public void generateScene(Scene scene) {
		...
		scene.setCamera(new Camera(new Point3f(10f, 3, 0), new Vector3f(-10, -3, 0), new Vector3f(0, 0, -1), 60));
...
//		teapot.setMaterial(new ReflectiveMaterial(0.9f));
		teapot.setMaterial(new RefractiveMaterial(new Color3f(1, 1, 1), 1.33f));
